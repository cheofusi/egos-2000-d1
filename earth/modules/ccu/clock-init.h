...
#define CCU_SDMMC0_CLK_REG                 (CCU_BASE+0x830)
#define CCU_SDMMC1_CLK_REG                 (CCU_BASE+0x834)
#define CCU_SDMMC2_CLK_REG                 (CCU_BASE+0x838)
#define CCU_SMHC_BGR_REG                   (CCU_BASE+0x84c)
